...
Update time:  2019-06-12 16:25:10

Auto created by [leetcode_generate](https://github.com/bonfy/leetcode)

I have solved **22   /   1023** problems
while there are **153** problems still locked.

If you want to use this tool please follow this [Usage Guide](https://github.com/bonfy/leetcode/blob/master/README_leetcode_generate.md)

If you have any question, please give me an [issue](https://github.com/agileup/leetcode.git/issues).
...
|:---:|:---:|:---:|:---:|:---:|
|1|[two-sum](https://leetcode.com/problems/two-sum)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0001-two-sum/two-sum.js)|[:memo:](https://leetcode.com/articles/two-sum/)|Easy|
|2|[add-two-numbers](https://leetcode.com/problems/add-two-numbers)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0002-add-two-numbers/add-two-numbers.js)|[:memo:](https://leetcode.com/articles/add-two-numbers/)|Medium|
...
|7|[reverse-integer](https://leetcode.com/problems/reverse-integer)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0007-reverse-integer/reverse-integer.js)|[:memo:](https://leetcode.com/articles/reverse-integer/)|Easy|
|8|[string-to-integer-atoi](https://leetcode.com/problems/string-to-integer-atoi)|||Medium|
|9|[palindrome-number](https://leetcode.com/problems/palindrome-number)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0009-palindrome-number/palindrome-number.js)|[:memo:](https://leetcode.com/articles/palindrome-number/)|Easy|
...
|13|[roman-to-integer](https://leetcode.com/problems/roman-to-integer)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0013-roman-to-integer/roman-to-integer.js)||Easy|
|14|[longest-common-prefix](https://leetcode.com/problems/longest-common-prefix)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0014-longest-common-prefix/longest-common-prefix.js)|[:memo:](https://leetcode.com/articles/longest-common-prefix/)|Easy|
...
|20|[valid-parentheses](https://leetcode.com/problems/valid-parentheses)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0020-valid-parentheses/valid-parentheses.js)|[:memo:](https://leetcode.com/articles/valid-parentheses/)|Easy|
|21|[merge-two-sorted-lists](https://leetcode.com/problems/merge-two-sorted-lists)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0021-merge-two-sorted-lists/merge-two-sorted-lists.js)|[:memo:](https://leetcode.com/articles/merged-two-sorted-lists/)|Easy|
...
|26|[remove-duplicates-from-sorted-array](https://leetcode.com/problems/remove-duplicates-from-sorted-array)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0026-remove-duplicates-from-sorted-array/remove-duplicates-from-sorted-array.js)|[:memo:](https://leetcode.com/articles/remove-duplicates-from-sorted-array/)|Easy|
|27|[remove-element](https://leetcode.com/problems/remove-element)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0027-remove-element/remove-element.js)|[:memo:](https://leetcode.com/articles/remove-element/)|Easy|
|28|[implement-strstr](https://leetcode.com/problems/implement-strstr)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0028-implement-strstr/implement-strstr.js)||Easy|
...
|35|[search-insert-position](https://leetcode.com/problems/search-insert-position)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0035-search-insert-position/search-insert-position.js)||Easy|
|36|[valid-sudoku](https://leetcode.com/problems/valid-sudoku)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0036-valid-sudoku/valid-sudoku.js)|[:memo:](https://leetcode.com/articles/valid-sudoku/)|Medium|
|37|[sudoku-solver](https://leetcode.com/problems/sudoku-solver)||[:memo:](https://leetcode.com/articles/sudoku-solver/)|Hard|
|38|[count-and-say](https://leetcode.com/problems/count-and-say)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0038-count-and-say/count-and-say.js)||Easy|
...
|66|[plus-one](https://leetcode.com/problems/plus-one)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0066-plus-one/plus-one.js)||Easy|
...
|136|[single-number](https://leetcode.com/problems/single-number)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0136-single-number/single-number.js)|[:memo:](https://leetcode.com/articles/single-number/)|Easy|
...
|189|[rotate-array](https://leetcode.com/problems/rotate-array)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0189-rotate-array/rotate-array.js)|[:memo:](https://leetcode.com/articles/rotate-array/)|Easy|
...
|204|[count-primes](https://leetcode.com/problems/count-primes)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0204-count-primes/count-primes.js)||Easy|
...
|217|[contains-duplicate](https://leetcode.com/problems/contains-duplicate)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0217-contains-duplicate/contains-duplicate.js)|[:memo:](https://leetcode.com/articles/contains-duplicate/)|Easy|
...
|326|[power-of-three](https://leetcode.com/problems/power-of-three)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0326-power-of-three/power-of-three.js)|[:memo:](https://leetcode.com/articles/power-of-three/)|Easy|
...
|412|[fizz-buzz](https://leetcode.com/problems/fizz-buzz)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0412-fizz-buzz/fizz-buzz.js)|[:memo:](https://leetcode.com/articles/fizz-buzz/)|Easy|
...
|461|[hamming-distance](https://leetcode.com/problems/hamming-distance)|[Javascript](https://github.com/agileup/leetcode.git/blob/master/solutions/0461-hamming-distance/hamming-distance.js)||Easy|
